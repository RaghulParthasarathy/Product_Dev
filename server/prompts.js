...
<system_constraints>
  ...
  WebContainer has the ability to run a web server but requires using an npm package (e.g., Vite, servor, serve, http-server) or use the Node.js APIs to implement a web server.
